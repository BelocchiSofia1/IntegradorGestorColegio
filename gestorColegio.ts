...
export default class GestorColegio {
    ...
    modificarAlumno(){
        ...
        if (indice === -1) {
           console.clear();
           console.log(`La Id: ${idAlumno} NO pertenece a ningun Alumno en el sistema`)
           console.log("");
        // si retorna >= 0 (indice del alumno encontrado):   
        }else if(indice >= 0){
        // menu de opciones para modificar al alumno.
         let opcionesAmodificar:string[] =[`Modificar Nombre`,`Modificar Apellido`,`Modificar Fecha De Nacimiento`,`Modificar Dni`,`Modificar Curso`,`Modificar Materias Matriculado`,`Modificar Nota Por Materia`]
        // muestro por consola en nombre y apelllido del alumno, para que mas intuitivo:
         console.log(`Alumno: ${arrayDeModificarAlumnos[indice].nombre}, ${arrayDeModificarAlumnos[indice].apellido}`);
        // le digo que seleccione una opcion del menu anterior:
        let valor = readLineSync.keyInSelect(opcionesAmodificar, `Seleccione la opcion a modificar del Alumno `);
        // creamos un switch con los casos que corresponda a la opcion elegida:
         switch (valor) {
           case 0:
               ...
               console.clear();
               console.log(`Se ha actualizado con exito la propiedad: NOMBRE a ${datoNombre}`);
               console.log("");
               break;
           case 1:
               console.clear();
               ...
               console.clear();
               console.log(`Se ha actualizado con exito la propiedad: APELLIDO a ${datoApellido}`);
               console.log("");
           ...
           case 2:
               ...
               console.clear();
               console.log(`Se ha actualizado con exito la propiedad: Fecha de nacimiento a ${datofechaDeNacimiento}`); 
               console.log("");
            ...
            case 3:
                ...
                console.clear();  
                console.log(`Se ha actualizado con exito la propiedad: DNI a ${datoDni}`);
                console.log("");      
                break;
           ...
           case 4:
               ...
               console.clear();
               console.log(`Se ha actualizado con exito la propiedad: CURSO del Alumno`);
            ...
            // si cambia de curso, por consecuencia cambia de materias:
                ...
                console.log(`Se ha actualizado con exito la propiedad: Materias del Alumno`);
            ...
            // si cambia de materias, por consecuencia cambia de nota por materia.
             ...
             console.clear();
             console.log(`Se ha actualizado con exito la propiedad: Nota por Materia del Alumno`);
             console.log("");
    ...
    escribir(arrayDeModificarAlumnos,"./Data/alumnos.json")
        ...
        console.log(`NO HAY ALUMNOS CREADOS PARA DAR UN LISTADO`);
        console.log("");
    ...
    modificarProfesor() {
        ...
        if(verificarExitencia("./Data/profesores.json")){
            ...
            if (indice === -1) {
               console.clear();
               console.log(`La Id: ${idProfe} NO pertenece a ningun Profesor en el sistema`)
               console.log("");
            //  si lo encontro:  
            }else if(indice >= 0){
            // menu de opciones a editar del profesor:
             let opcionesAmodificar:string[] =[`Modificar Nombre`,`Modificar Apellido`,`Modificar Fecha De Nacimiento`,`Modificar Dni`,`Modificar Salario`,`Modificar Materia/as que Dicta`]
            // muestro por consola el nombre y apellido del profesor para que sea mas intuitivo: 
             console.log(`Profesor: ${arrayDeModificarProfesores[indice].nombre}, ${arrayDeModificarProfesores[indice].apellido}`);
            // le digo que seleccione una opcion del menu anterior:  
            let valor = readLineSync.keyInSelect(opcionesAmodificar,`Seleccione la opcion a modificar del Profesor `);
             ...
             switch (valor) {
               ...
               case 2:
                ...
                case 4:
                    ...
                    console.clear();  
                    console.log(`Se ha actualizado con exito la propiedad: SALARIO a ${datoSalario}`);
                    console.log("");      
                    break;
        ...
        escribir(arrayDeModificarProfesores,"./Data/profesores.json")
            ...
            console.log("");
            // en el caso de que no exista el archivo:
            console.log(`NO HAY PROFESORES CREADOS PARA DAR UN LISTADO`);
            console.log("");
    ...
    crearListadoDeProfesoresXAlumno(){
        ...
        if(verificarExitencia("./Data/alumnos.json") && verificarExitencia("./Data/profesores.json")){
            ...
            if(AlumnoSolicitado != undefined){
                console.clear()
                console.log("");
                console.log(`Se ha encontrado al Alumno con EXITO`);
            ...
            for (let i = 0; i < arrayDeProfesores.length; i++) {
                ...
                if(profesoresDelAlumno.length > 0){
                    console.log("");
                    console.log(`Se ha creado el listado y el mismo ha sido exportado a la siguiente direccion: ./Listados/ProfesoresDe${AlumnoSolicitado.nombre.toLocaleUpperCase()}(${AlumnoSolicitado.id}).json`);
                    console.log("");
                ...
                // en caso de que no tenga ningun elemento el array(osea que no hay profesores)
                    ...
                    console.log(`El alumno con el ID: ${AlumnoSolicitado.id} no tiene profesores asignados a las materias que se matriculo`);
                }
            // en caso de que el alumno solicitado sea Undefine o ingreso un dato incorrecto:
            }else {
                console.log(`NO SE HA ENCONTRADO AL ALUMNO O HA INGRESADO UN DNI INCORRECTO`);
            }
        // en caso que no existan los archivos JSON:
        }else {
            console.log("");
                // en caso de no haber un listado de alumnos y profesores:
                console.log(`NO HAY ALUMNOS Y/O PROFESORES CREADOS PARA DAR UN LISTADO`);
                console.log("");
        }
    ...
    crearListadoDeAlumnosXProfesor(){
        ...
        if(verificarExitencia("./Data/alumnos.json") && verificarExitencia("./Data/profesores.json")){
            ...
            if(profesorSolicitado != undefined){
                console.clear()
                console.log("");
                console.log(`Se ha encontrado al Profesor con EXITO`);
            ...
            for (let i = 0; i < arrayDeAlumnos.length; i++) {
                ...
                if(alumnosDelProfesor.length > 0){   
                    console.log("");
                    console.log(`Se ha creado el listado y el mismo ha sido exportado a la siguiente direccion: ./Listados/alumnosDe${profesorSolicitado.nombre.toLocaleUpperCase()}(${profesorSolicitado.id}).json`);
                     console.log("");
                ...
                // en caso de que no tenga ningun elemento el array(osea que no hay alumnos)
                    ...
                    console.log(`El Profesor con el ID: ${profesorSolicitado.id} no tiene alumnos asignados a la/s materia/s que dicta`);
                }
            // en caso de que el alumno solicitado sea Undefine o ingreso un dato incorrecto:
            } else{
            console.log(`NO SE HA ENCONTRADO AL PROFESOR O HA INGRESADO UN DNI INCORRECTO`);
            }
        // en caso que no existan los archivos JSON:
        }else {
        console.log("");
    ...
    listadoDetodosLosAlumnosConPromedios(){
        if(verificarExitencia("./Data/alumnos.json")){
            ...
            console.log("");
            console.log(`Se ha creado el listado con exito`);
            console.log(`El mismo ha sido exportado a la siguiente direccion: ./Listados/alumnosPromedios.json`);
            console.log("");
    ...
    listadoDeAlumnos(){
        if(verificarExitencia("./Data/alumnos.json")){
            ...
            console.log("");
            console.log(`Se ha creado el listado de Alumnos (ordenado alfabeticamente) con exito!`);
            console.log(`El mismo ha sido exportado a la siguiente direccion: ./Listados/listado-alumnos.json`);
            console.log("");
    ...
    listadoDeProfesores(){
        if(verificarExitencia("./Data/profesores.json")){
            ...
            console.log("");
            console.log(`Se ha creado el listado de Profesores (ordenado alfabeticamente) con exito!`);
            console.log(`El mismo ha sido exportado a la siguiente direccion: ./Listados/listado-profesores.json`);
            console.log("");
